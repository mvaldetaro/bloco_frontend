Este projeto foi clonado de NG6, o readme abaixo é do projeto original.
Esse branch depende de ui+mock-base.

### Resumo
 * baixe ou clone o repositório em uma pasta
 * execute npm install (seu pc deve ter nodejs 6.x e npm)
 * execute npm start
 
 Seu projeto poderá ser acessado em http://localhost:3000.
